...
TWILIO_AUTH_TOKEN = 'c181e4a3475344c3a10e73806cc7ddc1'
ACCOUNT_FORMS = {
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'logs', 'payment_debug.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
